...
# el PC local), esto ya solo hace falta para Ollama/chat IA — DATABASE_URL se conecta
# directo a Supabase, sin pasar por el tailnet. Si no usas el chat, TS_AUTHKEY puede
# quedar vacío y este bloque entero se salta sin afectar la BD.
